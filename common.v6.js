...
var colorScaleTemp = d3.scaleLinear().domain([ 0, 8, 16, 18, 19, 22, 28, 32])
          .range(["darkturqoise", "darkviolet", "blue", "darkgreen", "green", "gold", "orange", "red"])
...
var colorScaleBattery = d3.scaleLinear().domain([ 30, 50, 60,  80, 100])
          .range(["red", "orange", "gold", "green", "green"])

var colorScaleLight = d3.scaleLinear().domain([ 0, 5, 50, 80, 100])
          .range(["darkblue", "darkorange", "orange", "gold",  "yellow"])
